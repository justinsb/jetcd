...
public class EtcdClient {
  ...
  private EtcdResult set0(final String key, final List<BasicNameValuePair> data, final int[] httpErrorCodes, final int... expectedErrorCodes)
  ...
  protected ListenableFuture<EtcdResult> asyncExecute(final HttpUriRequest request, final int[] expectedHttpStatusCodes, final int... expectedErrorCodes)
    throws EtcdClientException {
